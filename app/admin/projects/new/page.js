              ...
              >
                ...
                {project.blocks.map(block => {
                  switch(block.type) {
                    ...
                    case 'text':
                      return (
                        <div key={block.id} className="shrink-0 h-full w-[260px] p-6 bg-white border border-gray-100 overflow-y-auto">
                          <p className="text-[11px] leading-[1.6] text-black whitespace-pre-wrap font-medium">
